...
const typeConfig: Record<ActivityType, { bg: string; text: string; dot: string }> = {
  Listening: { bg: 'bg-blue-50', text: 'text-blue-700', dot: 'bg-blue-400' },
  Reading: { bg: 'bg-purple-50', text: 'text-purple-700', dot: 'bg-purple-400' },
  Writing: { bg: 'bg-emerald-50', text: 'text-emerald-700', dot: 'bg-emerald-400' },
  ...
  Vocabulary: { bg: 'bg-amber-50', text: 'text-amber-700', dot: 'bg-amber-400' },
